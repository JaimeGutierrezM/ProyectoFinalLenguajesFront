error id: file:///D:/ProyectoFinalLenguajesFront/frontend/src/main/scala/app/views/ProductView.scala:local5
...
object ProductView {
  def apply(
    ...
    val navButtonHover = onMouseOver --> { _.target.asIn@@stanceOf[dom.html.Button].style.backgroundColor = "#d35400" }
