error id: file:///D:/ProyectoFinalLenguajesFront/frontend/src/main/scala/app/views/PaginaPrincipal.scala:
file:///D:/ProyectoFinalLenguajesFront/frontend/src/main/scala/app/views/PaginaPrincipal.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/raquo/laminar/api/L.Libro#
	 -Libro#
	 -scala/Predef.Libro#
offset: 534
...
object PaginaPrincipal {
  ...
  def apply(currentView: Var[HtmlElement], librosVar: Var[List[L@@ibro]]): HtmlElement = {
