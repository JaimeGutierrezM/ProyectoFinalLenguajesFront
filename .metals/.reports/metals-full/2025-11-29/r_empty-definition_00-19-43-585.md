error id: file:///D:/ProyectoFinalLenguajesFront/frontend/src/main/scala/app/views/ReporteView.scala:
file:///D:/ProyectoFinalLenguajesFront/frontend/src/main/scala/app/views/ReporteView.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/raquo/laminar/api/L.item.nombre_persona.
	 -item/nombre_persona.
	 -scala/Predef.item.nombre_persona.
offset: 1447
        ...
        .map { xhr =>
            if (xhr.status == 200) {
                ...
                Compra(
                    ...
                    nombrePersona = item.nombre_per@@sona.toString,
