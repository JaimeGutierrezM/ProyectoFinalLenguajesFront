...
transition: 0.3s;
  ...
  button(
    styleAttr := """
      ...
      justify-content: center;
      gap: 10px;
      height: 44px;                /* misma altura que el otro botón */
      padding: 0 18px;
      background: #2c3e50;
      color: white;
      border: none;
    ...
    // Icono: usamos img con display:block para evitar desplazamientos de línea
    img(
      src := "assets/report-icon.svg",
      alt := "Informe",
      styleAttr := "width: 18px; height: 18px; display: block;"
    ),
