error id: file:///D:/ProyectoFinalLenguajesFront/frontend/src/main/scala/app/views/ProductView.scala:
file:///D:/ProyectoFinalLenguajesFront/frontend/src/main/scala/app/views/ProductView.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/raquo/laminar/api/L.Dynamic#
	 -Dynamic#
	 -scala/Predef.Dynamic#
offset: 367
...
object ProductView {
  def apply(
    ...
    personaVar: Var[Option[js.Dynami@@c]],
    logout: () => Unit
  ): HtmlElement = {
