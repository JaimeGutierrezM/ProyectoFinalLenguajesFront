error id: file:///D:/ProyectoFinalLenguajesFront/frontend/src/main/scala/app/views/PaginaPrincipal.scala:`<error>`#`<error>`.
file:///D:/ProyectoFinalLenguajesFront/frontend/src/main/scala/app/views/PaginaPrincipal.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -com/raquo/laminar/api/L.onClick.
	 -com/raquo/laminar/api/L.onClick#
	 -com/raquo/laminar/api/L.onClick().
	 -onClick.
	 -onClick#
	 -onClick().
	 -scala/Predef.onClick.
	 -scala/Predef.onClick#
	 -scala/Predef.onClick().
offset: 3336
