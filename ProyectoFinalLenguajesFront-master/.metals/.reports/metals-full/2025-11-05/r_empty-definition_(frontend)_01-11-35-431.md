error id: file:///D:/ProyectoFinalLenguajesFront-main/frontend/src/main/scala/app/views/PaginaPrincipal.scala:com/raquo/laminar/defs/tags/HtmlTags#div.
file:///D:/ProyectoFinalLenguajesFront-main/frontend/src/main/scala/app/views/PaginaPrincipal.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol com/raquo/laminar/defs/tags/HtmlTags#div.
...
object PaginaPrincipal {
  ...
  def apply(currentView: Var[HtmlElement], librosVar: Var[List[Libro]]): HtmlElement = {
    ...
    div(
      // ---------- CABECERA ----------
      div(
        // --- Contenedor general con fondo compartido ---
        styleAttr := """
          background-image: url('/frontimg/fondo.png');  /* tu imagen local */
  ...
  div(
    ...
    div(
      ...
      button(
        ...
        """,
        onClick --> { _ =>
          currentView.set(RegisterView(currentView, librosVar))
        }
      ),
      button(
        "INICIAR SESIÓN",
  ...
  div(
    ...
    p(
      "Descubre, comparte y guarda tus recetas favoritas en un solo lugar.",
      styleAttr := """
        font-size: 1.3rem;
        font-weight: 400;
        color: #f1f2f6;
      ...
      """
        ...
        @@div(
          ...
          button(
            ...
            onMouseOver.mapTo(true) --> { _ =>
              dom.document.querySelector("button").asInstanceOf[dom.html.Button].style.backgroundColor = "#27ae60"
            }
          ),
          button(
            "INICIAR SESIÓN",
      ...
      div(
        ...
        h2(
          ...
          styleAttr := "font-size: 2.4rem; color: #2f3640; margin-bottom: 10px; font-family: 'Poppins', sans-serif; font-weight: bold;"
        ),
        h3(
          "más solicitadas",
          styleAttr := "font-size: 2.4rem; color: #00572bff; margin-bottom: 0; font-family: 'Poppins', sans-serif; font-weight: bold;"
        )
      ),
      ),
      ...
      div(
        ...
        children <-- librosVar.signal.split(_.id_libro) { (_, libro, _) =>
          div(
            ...
            """,
            onMouseEnter --> { _ => dom.console.log("hover") },
            img(
      ...
      div(
        ...
        img(
          ...
          width := "60",
          height := "60",
          styleAttr := "margin-bottom: 10px;"
        ),
        p("LibroStore © 2025 - Todos los derechos reservados", styleAttr := "font-size: 0.95rem; margin: 0;")
      ),
